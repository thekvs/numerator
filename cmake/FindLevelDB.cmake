...
if (LEVELDB_INCLUDE_DIRS AND LEVELDB_LIBRARIES)
    ...
    find_library(SNAPPY_LIBRARIES NAMES libsnappy.a PATHS ${SNAPPY_LIBRARY_DIRS} /usr/lib/)
    find_library(LEVELDB_LIBRARIES NAMES libleveldb.a PATHS ${LEVELDB_LIBRARY_DIRS})
