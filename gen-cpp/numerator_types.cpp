...
void NumeratorException::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
...
const char* NumeratorException::what() const throw() {
  try {
    std::stringstream ss;
    ...
    return "TException - service has thrown: NumeratorException";
  }
}
